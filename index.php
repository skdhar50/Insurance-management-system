...
<html lang="en">
	...
	<body>
		...
		<main class="max-w-7xl mx-auto mt-4 relative">
			<header>
				<p
					class="
						text-4xl
					...
					<table class="shadow-xl table-fixed w-full">
						...
						<tbody>
							...
							<tr>
								<td>
									<?php
										$client = "select * from client where id = ".$row['client_id']."";
										$data = mysqli_query($con, $client);
										$result = mysqli_fetch_assoc($data);
										echo $result['client_name'];
									?>
								</td>
								<?php
									$scheme = "select * from scheme where id = ".$row['scheme_id']."";
									$data = mysqli_query($con, $scheme);
									$result = mysqli_fetch_assoc($data);
								 	echo "<td>".$result['scheme_name']."</td>";
								...
								<td>
									<a
										href="add_insurance.php?edit=<?php echo $row['id']; ?>"
										class="
											py-1
											px-3
											bg-green-700
