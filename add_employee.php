	...
	<body>
		...
		<?php
			...
			if(isset($_POST['add']))
			{
				...
				$sql = "insert into employee (employee_name, email, branch_id, contact, address) values('$employee_name', '$email', '$branch_id', '$contact', '$address')";
			...
			if(isset($_POST['edit']))
			{
				...
				$sql = "update employee set employee_name = '$employee_name', email = '$email' , branch_id = '$branch_id', contact = '$contact', address = '$address' where id = '$id'";
