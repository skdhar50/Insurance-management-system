		...
		<?php
			...
			if(isset($_GET['edit'])) {
				...
				if(mysqli_num_rows($res) > 0) {
					...
					$brn_name = $data['branch_name'];
					$brn_code = $data['branch_code'];
					$addrs = $data['address'];
					$update = true;
				}
			}
			...
			if(isset($_POST['add']))
			{
				...
				$sql = "insert into branch (branch_name,branch_code,address) values('$branch_name','$branch_code','$address')";
			...
			if(isset($_POST['edit']))
			{
				...
				$sql = "update branch set branch_name = '$branch_name',branch_code = '$branch_code',address = '$address' where id = '$id'";
